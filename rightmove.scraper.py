...
class RightmoveScraper:
    ...
    def run(self, location):
        for page in range(0, 5):
            index = page * 24
            url = 'https://www.rightmove.co.uk/property-for-sale/find.html?locationIdentifier=' + location + '&index=' + str(index) + '&propertyTypes=&mustHave=&dontShow=&furnishTypes=&keywords='
...
if __name__ == '__main__':
    location = 'REGION%5E1646'  # Change this to the desired location identifier
